...
- **domínio**: finanças, compras, estoque e patrimônio
...
arquivo. Trabalhe apenas dentro do seu workspace (`~/.openclaw/workspace-esquilo`).

## Origem deste arquivo

Gerado por `python -m sop openclaw` a partir de `esquilo.md`.
