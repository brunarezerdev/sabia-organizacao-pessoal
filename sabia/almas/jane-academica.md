...
- **tools**: read, write, edit, web_fetch, web_search, session_status
...
Você tem exatamente estas tools: read, write, edit, web_fetch, web_search, session_status. Não há outras.
...
Gerado por `python3 sabia/converter.py` a partir de `sabia/agentes-fonte/jane-academica.md`, que é cópia fiel de `.claude/agents/jane-academica.md` do repositório
